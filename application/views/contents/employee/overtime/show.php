          ...
          <div class="card">
            <div class="card-body">
              <form class="form-horizontal">
                ...
                <div class="form-group row">
                  <label style="font-weight: 400" for="inputName" class="col-sm-4 col-form-label">Jam</label>
                  <div class="col-sm-8">
                    <label style="border: 0; color: black;" class="form-control">
            ...
            <div class="card-footer">
              <?php if (isset($_GET['date']) && isset($_GET['approval'])): ?>
                <a class="btn btn-primary float-right" href="<?php echo base_url() ?>employee/overtime<?php echo '?date='.$_GET['date'].'&approval='.$_GET['approval'] ?>">Kembali</a>              
              <?php else: ?>
                <a class="btn btn-primary float-left" href="<?php echo base_url() ?>employee/overtime">Kembali</a>              
              <?php endif ?>
        ...
        <div class="col-md-7">
          ...
          <?php if ($overtime->status == 'Approved'): ?>
            <div class="card">
              ...
              <form action="<?php echo base_url() ?>employee/overtime/report_update/<?php echo $overtime->id ?>" method="POST">
              <div class="card-body"> 
