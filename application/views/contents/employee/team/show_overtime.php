          ...
          <div class="card">
            ...
            <div class="card-footer">
              <?php if (isset($_GET['date'])): ?>
                <a class="btn btn-primary float-right" href="<?php echo base_url() ?>employee/team/overtime<?php echo '?date='.$_GET['date'].'&approval='.$_GET['approval'].'&employee='.$_GET['employee'] ?>">Kembali</a>              
              <?php else: ?>
                <a class="btn btn-primary float-right" href="<?php echo base_url() ?>employee/team/overtime">Kembali</a>              
              <?php endif ?>

              <?php if (!$report->row() && date('Y-m-d') != $overtime->overtime_date && date('Y-m-d') < $overtime->overtime_date): ?>
                <a class="btn btn-info float-left" href="<?php echo base_url() ?>employee/team/edit_overtime/<?php echo $overtime->id ?>"><i class="fa fa-edit"></i> Ubah</a>                
              <?php endif ?>
