          ...
          <div class="card">
            ...
            <div class="card-footer">
              <?php if (isset($_GET['date']) && isset($_GET['approval']) && isset($_GET['employee'])): ?>
                <a class="btn btn-primary float-right" href="<?php echo base_url() ?>employee/team/leave<?php echo '?date='.$_GET['date'].'&approval='.$_GET['approval'].'&employee='.$_GET['employee'] ?>">Kembali</a>              
              <?php else: ?>
                <a class="btn btn-primary float-left" href="<?php echo base_url() ?>employee/team/leave">Kembali</a>              
              <?php endif ?>
            </div>
