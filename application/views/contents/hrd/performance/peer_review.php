      <div class="row">
        <div class="card-body">
          <form action="<?php echo base_url() ?>hrd/performance/peer_review" method="GET">
        ...
        <?php if (isset($_GET['year']) && isset($_GET['employee']) && isset($_GET['org_unit'])): ?>
            ...
            <div class="card-body">
              <table id="table" class="table table-bordered table-striped">
                ...
                <tr>
                  ...
                  <td class="center"><?= $value->status_reviewer ?></td>
                  <td class="center"><?= ($value->status_assessment) ? $value->status_assessment : '-' ?></td>
                  <td class="center">
                    <a href="<?php echo base_url() ?>hrd/performance/detail_peer_review/<?php echo $value->id ?>" title="detail" class="btn btn-info btn-xs"><i class="fa fa-search" aria-hidden="true"></i></a>
                  </td>
                </tr>
                <?php } ?>
                </tbody>
