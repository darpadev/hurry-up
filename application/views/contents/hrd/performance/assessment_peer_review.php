      <div class="row">
        <div class="card-body">
          <form action="<?php echo base_url() ?>hrd/performance/assessment_peer_review" method="GET">
        ...
        <div class="col-md-12 col-lg-12">
          <div class="card">
            <?php if (true): // check tanggal penginputan kalender ?>
              <div class="card-header">
                <div style="float: left;">
                  <button type="button" class="btn btn-success add-row-peer-review"><span class="fa fa-calendar"></span> &nbsp;Tambah</button>
                  <button type="button" class="btn btn-danger delete-row-peer-review delete-confirmation"><span class="fa fa-trash"></span> &nbsp;Hapus</button>
                </div>

                <div style="float: right;">
                  <form method="POST" action="<?php echo base_url() ?>hrd/performance/copy_criteria_peer_review_period">
            ...
            <form method="POST" action="<?php echo base_url() ?>hrd/performance/store_criteria_peer_review">
            ...
            <div class="card-body">
              <table id="" class="table table-bordered table-striped">
                ...
                <tr>
                  ...
                  <th class="center" style="width: 10%">No. Urut</th>
                </tr>
                </thead>
                <tbody>
                <?php $no = 1;
                ...
                <?php if ($value->status == 8): ?>
                  ...
                  <tr>
                    ...
                    <td>
                      <input type="number" min="0" class="form-control" name="u_sequence[]" value="<?php echo $value->sequence ?>" required>
                    </td>
                  </tr>                  
                <?php else: ?>
                  <tr>
                    ...
                    <td>
                      <input style="border: none; background: transparent;" name="u_kpi[]" type="number" min="0" class="form-control"  value="<?php echo $value->sequence ?>" readonly>
                    </td>
                  </tr>
                <?php endif ?>
                <?php } ?>
