        ...
        <div class="col-md-5">
          <div class="card">
            ...
            <div class="card-footer">                
              <a class="btn btn-primary float-right" href="<?php echo base_url() ?>hrd/overtime/overtime<?php echo '?date='.$_GET['date'].'&approval='.$_GET['approval'] ?>">Kembali</a>
            </div>
          </div>
        </div>
        <div class="col-md-7">
          ...
          <?php else: ?>
            <p style="color: red"><strong>* Pegawai ini belum membuat kegiatan lembur</strong></p>
          <?php endif ?>
