          <div class="col-md-12">
            <div class="card card-primary card-outline">
              ...
              <form action="<?php echo base_url() ?>hrd/employee/update/<?php echo $data->employee_id ?>" method="POST" enctype="multipart/form-data">
                <div class="card-body">
                  <div class="row">
                  <div class="col-md-6">
                    ...
                    <div class="form-group">
                      ...
                      <div class="form-group">
                        ...
                        <div class="input-group">
                          ...
                          <input type="text" class="form-control datepicker" name="join_date" value="<?php echo date('d-m-Y', strtotime($data->join_date)) ?>" >
                        </div>
                      </div>
                      <div class="form-group">
                      ...
                      <div class="form-group">
                        ...
                        <select name="status" class="form-control" required>
                          ...
                          <?php foreach ($this->db->get('employee_status')->result() as $empstat): ?>
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" name="work_agreement_status" class="form-control" value="<?php echo $data->work_agreement_status ?>" >
                      </div>                     
                      <div class="form-group">
                        <label>RFID</label>
                ...
                <div class="card-footer">
                  <div class="float-right">
                    <a href="<?php echo base_url() ?>hrd/employee/show/<?php echo $data->employee_id ?>" class="btn btn-default">Kembali</a>
