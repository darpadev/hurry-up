        <div class="modal fade" id="modal-add-data">
          <div class="modal-dialog modal-xl">
            <div class="modal-content">
              ...
              <form action="<?php echo base_url() ?>hrd/employee/store" method="POST" enctype="multipart/form-data">
                  ...
                  <div class="row">                    
                    ...
                    <div class="col-md-6 col-lg-6">
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" name="work_agreement_status" class="form-control">
                      </div>                    
                      <div class="form-group">
                        <label>RFID</label>
                          ...
                          <div class="input-group">
                            ...
                            <div class="col-md-3">
                              ...
                              <div class="input-group">
                                ...
                                <input type="text" class="form-control datepicker" name="graduates[]">
                              </div>
