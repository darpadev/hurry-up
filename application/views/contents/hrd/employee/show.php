	...
	<div class="col-md-3">
		<div class="card card-primary card-outline">
          <div class="card-body box-profile">
            ...
            <?php if (@$employee->nidn): ?>            	
	            <p class="text-muted text-center">NIDN. <?php echo $employee->nidn ?></p>
            <?php endif ?>

            <?php if (@$employee->nitk): ?>            	
	            <p class="text-muted text-center">NITK. <?php echo $employee->nitk ?></p>
            <?php endif ?>

            <?php if (@$employee->nidk): ?>            	
	            <p class="text-muted text-center">NIDK. <?php echo $employee->nidk ?></p>
            <?php endif ?>

            <a href="javascript:void(0);" class="btn btn-primary btn-block"><b><?php echo $employee->status ?></b></a>
          </div>
        </div>
	</div>
					...
					<div class="active tab-pane" id="employee">
						<form class="form-horizontal">
							...
							<div class="form-group row">
		                        ...
		                        <div class="col-sm-9">
		                          <label style="border: 0; color: black;" class="form-control">
		                          	<?php echo (@$employee->functional_position) ? $employee->functional_position : '-'; ?>
		                          </label>
		                        </div>
							</div>
							<div class="form-group row">
		                        ...
		                        <div class="col-sm-9">
		                          <label style="border: 0; color: black;" class="form-control">
		                          	<?php echo (@$employee->extension) ? $employee->extension : '-'; ?>
		                          </label>
		                        </div>
							</div>
							<div class="form-group row">
		                        ...
		                        <div class="col-sm-9">
		                          <label style="border: 0; color: black;" class="form-control">
		                          	<?php echo tanggal($employee->join_date) ?>
		                          </label>
		                        </div>
							</div>
							<div class="form-group row">
					...
					<div class="tab-pane" id="personal">
						<form class="form-horizontal">
							...
							<div class="form-group row">
		                        ...
		                        <div class="col-sm-9">
		                          <label style="border: 0; color: black;" class="form-control">
		                          	<?php echo tanggal($employee->birthday) ?>
		                          </label>
		                        </div>
							</div>
							<div class="form-group row">
			...
			<div class="card-footer">
				<div class="float-right">	
					<?php if (isset($_GET['group']) && isset($_GET['status']) && isset($_GET['org_unit']) && isset($_GET['position'])): ?>
						<a class="btn btn-default" href="<?php echo base_url() ?>hrd/employee<?php echo '?group='.$_GET['group'].'&status='.$_GET['status'].'&org_unit='.$_GET['org_unit'].'&position='.$_GET['position'] ?>"><span class="fa fa-reply"></span>&nbsp;&nbsp; Kembali</a>
					<?php else : ?>
						<a class="btn btn-default" href="<?php echo base_url() ?>hrd/employee"><span class="fa fa-reply"></span>&nbsp;&nbsp; Kembali</a>	
					<?php endif ?>
			        
			        <a class="btn btn-primary" href="<?php echo base_url() ?>hrd/employee/edit/<?php echo $employee->employee_id ?>"><span class="fa fa-edit"></span>&nbsp;&nbsp; Ubah</a>
				</div>
			</div>
		</div>
	</div>
