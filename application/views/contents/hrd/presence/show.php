          ...
          <div class="row">
            ...
            <div class="col-md-6">                  
              <div class="form-group clearfix">
                ...
                <input type="text" class="form-control" name="temperature" value="<?php echo $data->temperature ?>" required disabled>
              </div>
            </div>
            <div class="col-md-6">  
              <div class="form-group clearfix">
                <label>Latitude Datang</label>
                <input type="text" class="form-control" name="lat_checkin" value="<?php echo $data->lat_checkin ?>" required disabled>
              </div>
            </div>

            <div class="col-md-6">                  
              <div class="form-group clearfix">
                <label>Longitude Datang</label>
                <input type="text" class="form-control" name="long_checkin" value="<?php echo $data->long_checkin ?>" required disabled>
              </div>
            </div>
            <div class="col-md-6">  
              <div class="form-group clearfix">
                <label>Latitude Pulang</label>
                <input type="text" class="form-control" name="lat_checkout" value="<?php echo $data->lat_checkout ?>" required disabled>
              </div>
            </div>
            ...
            <div class="col-md-6">                  
              <div class="form-group clearfix">
                ...
                <input type="text" class="form-control" name="long_checkout" value="<?php echo $data->long_checkout ?>" required disabled>
              </div>
            </div>
          </div>               
          <div class="form-group">
